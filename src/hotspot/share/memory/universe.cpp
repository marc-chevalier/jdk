...
static BuiltinException _negative_array_size_exception;
...
oop Universe::negative_array_size_exception_instance()     { return _negative_array_size_exception.instance(); }
...
void Universe::archive_exception_instances() {
  ...
  _negative_array_size_exception.store_in_cds();
}
...
void Universe::load_archived_object_instances() {
  if (ArchiveHeapLoader::is_in_use()) {
    ...
    _negative_array_size_exception.load_from_cds();
  }
}
#endif
...
void Universe::serialize(SerializeClosure* f) {
  ...
  _negative_array_size_exception.serialize(f);
#endif
...
bool universe_post_init() {
  ...
  _negative_array_size_exception.init_if_empty(vmSymbols::java_lang_NegativeArraySizeException(), CHECK_false);
