...
struct LinearCombination {
  ...
  public:
    ...
    Combination sum(const Combination& other, const bool neg, bool& improves) const {
  ...
  //
  static bool ok_to_convert(Node* inc, const Node* var) {
